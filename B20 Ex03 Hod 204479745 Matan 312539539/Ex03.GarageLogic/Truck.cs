namespace Ex03.GarageLogic
{
    public class Truck : Vehicle
    {
        ...
        public Truck(string i_Id, string i_ModelName, Engine i_Engine, bool i_IsContainingDangerousProducts, float i_CargotVolume) : base(i_Id, i_ModelName, i_Engine, 16)
        {
